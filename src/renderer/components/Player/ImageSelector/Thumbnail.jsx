...
import { StyledThumbnail, Image, Index } from '../../../stylesheets/player/ImageSelector/Thumbnail';

const Thumbnail = SortableElement(
  ({ figure, sortIndex, onClick, onDeleteButtonClick, isSelected, isEditable, size, contentType }) => (
    <StyledThumbnail data-index={sortIndex} size={size}>
      <Image
