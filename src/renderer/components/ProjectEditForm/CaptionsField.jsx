...
import CaptionField from './CaptionField.jsx';
...
const CaptionsField = ({ figures, contentType, handleCaptionsChange, onAddCaptionButtonClick }) => {
  return (
    <StyledCaptionsField>
      ...
      <StyledCaptionFieldHeader>
        <CaptionFieldSpan text="start" contentType={contentType}>
          start(h:m:s)
        </CaptionFieldSpan>
        <CaptionFieldSpan text="end" contentType={contentType}>
          end(h:m:s)
        </CaptionFieldSpan>
        <CaptionFieldSpan text="text" contentType={contentType}>
          caption
        </CaptionFieldSpan>
      ...
      {figures.map((figure, figureIndex) => {
        return (
          <CaptionFieldWrapper key={`figure_${figure.id}_captions`} figureWillBeDeleted={figure._destroy}>
            ...
            <AddCaptionButton className="addCaptionButton" onClick={onAddCaptionButtonClick} data-index={figureIndex}>
              add caption
            </AddCaptionButton>
          </CaptionFieldWrapper>
        );
